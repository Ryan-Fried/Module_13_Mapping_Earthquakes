...
d3.json(earthquakeData).then(function(data) {
  console.log(data);
    //This function returns the style data for each of the earthquakes we plot. We pass the magnitude function of the earthquake into a function to calculate the radius
